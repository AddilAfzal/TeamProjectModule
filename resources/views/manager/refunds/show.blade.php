    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            <tr>
                <td width="30%">Customer</td>
                  <td>  <a href="/manager/customers/{{$refund->sale->customer->id}}">{{($refund->sale->customer->Firstname . " " . $refund->sale->customer->Surname)}}</a></td>
            </tr>
        </table>
        ...
        <table class="table table-bordered">
            <tr>
                ...
                <td>  <a href="/manager/sales/{{$refund->sale->id}}">{{($refund->sale->SaleRef)}}</a></td>
            </tr>
        </table>
