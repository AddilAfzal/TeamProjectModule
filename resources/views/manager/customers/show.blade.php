...
@section('content')
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            @foreach($customer->sales()->limit(5)->get() as $sale)
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="customerType" name="customerType" required>
                                    ...
                                    @foreach(\App\Customer::$account_types as $type)
                                        <option value="{{$type}}">{{ title_case($type)}}</option>
                                    @endforeach
                                </select>
                                <p class="help-block">This will remove any discount plan associated with this
                                    account.</p>
                            </div>
        ...
        <div class="modal fade update-contact-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="/manager/customers/update/contact" method="post">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                        aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="gridSystemModalLabel">
        ...
        @if(count($awaiting_payment) > 0)
            <a href="/manager/customers/{{$customer->id}}/payment-letter" type="button" class="btn btn-extra-1"><i
                        class="fa fa-file-text-o" aria-hidden="true"></i> Issue Payment Reminder
            </a>
        ...
        <div class="modal fade delete-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="/manager/customers/delete/" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="customerId" value="{{$customer->id}}">
                                <p>Are you sure that you would like to delete this customer account?</p>
                            </div>
