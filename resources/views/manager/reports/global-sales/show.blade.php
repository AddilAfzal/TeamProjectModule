...
@section('content')
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/manager/reports/global-sales/create">Global Sales</a></li>
    ...
    <script >
        ...
        function printPDF()
        {
            var w = window.open('/manager/reports/global-sales/pdf?dateFrom=' + getUrlParameter('dateFrom') + '&dateTo=' + getUrlParameter('dateTo') + '&reportScope=' + getUrlParameter('reportScope'));
            w.print();
        }
