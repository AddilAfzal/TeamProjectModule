...
@section('content')
    ...
    <script >
        ...
        {
            var a = '{{$link}}';
            var w = window.open('/manager/reports/individual-sales/pdf?dateFrom=' + getUrlParameter('dateFrom') + '&dateTo=' + getUrlParameter('dateTo') + '&reportScope=' + getUrlParameter('reportScope') + '&advisor=' + getUrlParameter('advisor'));
            w.print();
        }
